...
namespace ActionFit.AiJira.Editor.Tests
{
    public class AiJiraSkillInstallServiceTests
    {
        ...
        public void SetUp()
        {
            ...
            WriteSource("Codex", "jira-plan", "codex plan");
            WriteSource("Codex", "jira-auto-start", "codex auto start");
            WriteSource("Codex", "jira-run", "codex run");
            WriteSource("Claude", "jira-help", "claude help");
            WriteSource("Claude", "jira-todo", "claude todo");
            WriteSource("Claude", "jira-plan", "claude plan");
            WriteSource("Claude", "jira-auto-start", "claude auto start");
        ...
        public void FirstInstallAndRepeatAreIdempotent()
        {
            ...
            Assert.That(first.Installed, Is.EqualTo(10));
            Assert.That(second.Unchanged, Is.EqualTo(10));
            ...
            Assert.That(File.ReadAllText(Target(".agents", "jira-auto-start", "SKILL.md")),
                Is.EqualTo("codex auto start"));
        ...
        public void PackageUpdateRefreshesOnlyUnmodifiedManagedSkill()
        {
            ...
            Assert.That(result.Unchanged, Is.EqualTo(9));
        ...
        public void RemoveDeletesOnlyUnchangedManagedTargets()
        {
            ...
            Assert.That(result.Removed, Is.EqualTo(9));
            Assert.That(result.Warnings, Has.Count.EqualTo(1));
        ...
        public void ExistingUnmanagedTargetIsNeverAdoptedOrOverwritten()
        {
            ...
            Assert.That(result.Installed, Is.EqualTo(9));
            Assert.That(result.Warnings, Has.Count.EqualTo(1));
