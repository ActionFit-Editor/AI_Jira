...
4. Read `AGENTS.md`, `CLAUDE.md`, linked repository guidance, `references/planning-decision-collaboration.md`, and `references/completion-baseline-gate.md` before judging scope or deciding that an implementation direction is unambiguous.
