...
class JiraHelpSkillTests(unittest.TestCase):
    def test_codex_help_reads_generated_inventory_and_documents_command_safety(self) -> None:
        ...
        self.assertIn("configured base lifecycle", contents)
        self.assertIn("extended development-complete states", contents)
        ...
        self.assertIn("verify inspect", contents)
        self.assertIn("reclassify-legacy inspect", contents)
        self.assertIn("reclassify-legacy preflight", contents)
        self.assertIn("reclassify-legacy apply", contents)
        self.assertIn("never discovers or bulk-migrates", contents)
        self.assertIn("automatic-validation", contents)
